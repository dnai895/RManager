    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.html">CLASS ROYAL</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="portfolio-1-col.html">Ver mesas</a>
                            </li>
                            <li>
                                <a href="portfolio-2-col.html">+ Añadir mesas</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="blog-home-1.html">Ver platos</a>
                            </li>
                            <li>
                                <a href="blog-home-2.html">+ Añadir plato</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
